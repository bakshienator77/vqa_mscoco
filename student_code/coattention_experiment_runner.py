...
from student_code.coattention_net import CoattentionNet, CoattentionNetSentenceOnly
...
class CoattentionNetExperimentRunner(ExperimentRunnerBase):
    ...
    def __init__(self, train_image_dir, train_question_path, train_annotation_path,
                 ...
                 num_data_loader_workers, cache_location, lr, log_validation, sentence_only=False):
        ...
        if not sentence_only:
            ...
            self._model = CoattentionNetSentenceOnly(train_dataset.question_word_list_length, 512, train_dataset.answer_list_length).cuda()
